...
public class TaskManagerOld extends ListActivity {
    /*
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_task_manager_old);
        ...
        mCreateBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (getInput == null) {
                    Toast.makeText(TaskManagerOld.this, "Field can't be empty", Toast.LENGTH_SHORT).show();
                }

                if (obj.size() == task_icons.length() ){
                    Toast.makeText(TaskManagerOld.this, "Max amount of tasks reached", Toast.LENGTH_SHORT).show();
                }
